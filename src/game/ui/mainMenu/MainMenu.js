...
class MainMenu extends HTMLElement {
  ...
  connectedCallback() {
    ...
    const onPlay2ButtonClick = this.onPlay2ButtonClick.bind(this);
    const play2Button = this.shadowRoot.querySelector('.main-menu__play-2');
    play2Button.addEventListener('click', onPlay2ButtonClick);
    this.listeners.push(() => {
      play2Button.removeEventListener('click', onPlay2ButtonClick);
    });
